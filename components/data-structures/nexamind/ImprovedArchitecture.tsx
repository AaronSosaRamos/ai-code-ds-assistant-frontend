...
const ImprovedArchitecture = () => {
    ...
    const { architecture, requirements, suggestions } = data?.improved_architecture;
    ...
    return (
        ...
        >
            ...
            {suggestions && (
                <div className="mt-10">
                    <h2 className="text-3xl font-bold text-blue-800 dark:text-blue-300 mb-6 flex items-center">
                        <FaCog className="mr-3 text-blue-500" /> Suggestions
                    </h2>
                    ...
                    {suggestions.map((suggestion: any, index: number) => (
                        ...
                        >
                            <h4 className="text-lg font-semibold text-gray-800 dark:text-white flex items-center">
                                <HiOutlineLightBulb className="mr-2 text-yellow-500" /> {suggestion.suggestion || "Unnamed Suggestion"}
                            </h4>
                            <p className="text-gray-600 dark:text-gray-400 mt-2">{suggestion.details || "No details available."}</p>
                        </motion.div>
                    ))}
                </div>
            )}
            ...
            <motion.button
                type="button"
                onClick={() => {
                    router.push('/nexamind/architecture-with-quality-attributes');
                }}
                ...
                whileTap={{ scale: 0.95 }}
            >
                Go to the Architecture with Quality Attributes
            </motion.button>
        </motion.div>
    );
};

export default ImprovedArchitecture;
